...
const Footer = () => {
    return (
        ...
        <footer className="footer p-10 bg-base-200 text-base-content">
            <div>
                <h1><span className="text-red-500 font-extrabold">Food</span>
                <span className="text-blue-500 font-extrabold">2</span>
                <span className="text-yellow-400 font-extrabold">Door</span></h1>
                <p className='p-1'>Connecting Farmers to Your Table
                <br/>
